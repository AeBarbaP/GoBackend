        ...
        <nav class="navbar navbar-expand-md">
            <div class="container-fluid justify-content-center">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark active" aria-current="page" href="e-bloqueados.php"><i class="bi bi-calendar-minus"></i> Eventos Bloqueados</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="container-fluid rounded-3 p-1 mt-2">
                ...
                <div class="mt-1">
                    ...
                    <?php 
                        ...
                        while ($rowSqlEvent_b = $sqlResultEvent_b->fetch_assoc()){

                            echo'
                            <div class="col-sm-3">
                                <a href="home_config.php?id='.$rowSqlEvent_b['id'].'" class="text-dark" style="text-decoration: none;">
                                <div class="card mb-3" style="max-width: 540px;">
                                    <div class="row g-0">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="card-body">
                                                <h5 class="card-title">'.$rowSqlEvent_b['nombre_e'].'</h5>';
                                                
                                                $idOrganizador = $rowSqlEvent_b['id_organizador'];
                                               ...
                                               if($rowSqlEvent_b['status_e'] == 4){
                                                    echo '<p class="card-text">Status: <i class="bi bi-check-circle-fill text-success"> Bloqueado</i></p><!-- OJO Status disponibles: Activo, Cancelado, Bloqueado y Finalizado con 4 flags-->';
                                                }
                                                else{
                                                ...
                                                <p class="card-text"><small class="text-muted">Evento creado: '.$rowSqlEvent_b['fecha_e'].'</small></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
