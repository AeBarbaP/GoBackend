                                        ...
                                        <div class="col-sm-8">
                                            <div class="card-body">
                                               ...
                                               if($rowSqlEvent_f['status_e'] == 5){
                                                    echo '<p class="card-text">Status: <i class="bi bi-check-circle-fill text-dark"> Finalizado</i></p><!-- OJO Status disponibles: Activo, Cancelado, Bloqueado y Finalizado con 4 flags-->';
                                                }
                                                else{
