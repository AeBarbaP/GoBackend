      ...
      <div class="col-md-12">
        <div class="h-100 p-4 text-dark bg-light border rounded-3">
          ...
          <div class="row">
            ...
            <div class="col-8">
              <div class="form-floating mb-3">
                <input type="text" class="form-control rounded-4" id="floatingPassword" placeholder="Etiqueta" name="email" required>
                <label for="floatingPassword">Etiqueta para Invitación</label>
              </div>
            </div>
            <div class="col-4">
              <div class="form-floating mb-3">
                <input type="text" class="form-control rounded-4" id="floatingPassword" placeholder="No. Mesa" name="celular" required>
      ...
      <table class="table table-hover table-bordered align-middle mt-4">
        <thead style="background-color:#f7c6bf; color: #7B8DAB;">
          <tr class="text-center">
            ...
            <th scope="col">Total Invitados <br> Total Confirmados</th>
