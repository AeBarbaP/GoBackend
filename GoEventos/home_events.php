...
>>>>>>> ae68399f5622759c320961427421232148cf27af
        </div>
            ...
            while ($row_sqlQuery = $resultadosqlQuery->fetch_assoc()) {
              ...
              echo '
                          <tr class="text-center">
                            ...
                            data-bs-target="#AgregarAcomp" onclick="valor(' . $row_sqlQuery['id'] . ')"><span class="badge bg-light text-dark"><i class="bi bi-person-plus"></i> Agregar Acompañante</span></a></td>
                          ...
                          <div class="container">
                            <table class="table">
                              ...
                              <tbody>
                                <tr>
                                  <th scope="row">1</th>
                                  <td><input type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="invitados" value="' . $row_sqlQuery['no_invitados'] . '"></td>
                                  <td><input type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="invitados" value="' . $row_sqlQuery['no_invitados'] . '"></td>
                                  <td><input type="text" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="invitados" value="' . $row_sqlQuery['no_invitados'] . '"></td>
                                  <td><i class="bi bi-pen-fill"></i></i></td>
      ...
      ';
        ...
        function valor(x) {
            var valorid = x;
            /* document.getElementById("valorfull").value = valorid; */
            /* alert(valorid); */

            $.ajax({
                url: 'prcd/obtenervalor.php',
                type: 'POST',
                async: true,
                data: 'parametro1=valorid',
        ...
        <?
    $idconsulta = $_POST['parametro1'];
    echo $idconsulta;

    $sql = "select * from invitados where id='$idconsulta'";
    $resultadosql = $conn->query($sql);
    $row_sql = $resultadosql->fetch_assoc();

    echo '
                <!-- Inicia Modal -->
                <div class="modal fade" id="AgregarAcomp" tabindex="-1" aria-labelledby="Agregar Acompañante" aria-hidden="true">
                  <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                      ...
                      <div class="modal-body text-dark">
                        <form class="">
                          <fieldset disabled>    
                            <div class="row">
                              <div class="col-4">
                                <div class="form-floating mb-3 ">
                                  <input type="text" class="form-control rounded-4" id="floatingPassword"
                                    placeholder="username" aria label="Username" aria-describedby="basic-addon1" name="apellido_p" value="' . $row_sql['apellido_p'] . '">
                                  <label for="floatingPassword">Apellido Paterno</label>
                                </div>
                              </div>
                              <div class="col-4">
                                <div class="form-floating mb-3 ">
                                  <input type="text" class="form-control rounded-4" id="floatingPassword"
                                  placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="apellido_m" value="' . $row_sql['apellido_m'] . '" dis>
                                  <label for="floatingPassword">Apellido Materno</label>
                                </div>
                              </div>
                              <div class="col-4">
                                <div class="form-floating mb-3 ">
                                  <input type="text" class="form-control rounded-4" id="floatingPassword" 
                                  placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="nombre" value="' . $row_sql['nombre'] . '">
                                  <label for="floatingPassword">Nombre (s)</label>
                                </div>
                              </div>
                              <div class="col-8">
                                <div class="form-floating mb-3">
                                  <input type="text" class="form-control rounded-4" id="floatingPassword" 
                                  placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="email" value="' . $row_sql['email'] . '">
                                  <label for="floatingPassword">Correo-e</label>
                                </div>
                              </div>
                              <div class="col-4">
                                <div class="form-floating mb-3">
                                  <input type="text" class="form-control rounded-4" id="floatingPassword" 
                                  placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" name="celular" value="' . $row_sql['celular'] . '">
                                  <label for="floatingPassword">Celular</label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-4">
                              <div class="form-floating mb-3">
                                <input type="number" class="form-control rounded-4" id="cambioCeldasInput' . $row_sql['id'] . '"
                                  placeholder="Número de acompañantes" onchange="cambioCeldas(' . $row_sql['id'] . ')" onblur="bloquear(' . $row_sql['id'] . ')" pattern="[0-9]" max-lenght="2" >
                                <label for="floatingPassword">Número de acompañantes</label>
                              </div>
                            </div>
                            <div class="col-8">
                            ...
                            <hr>
                            <p class="mt-3 mb-2"><span class="h5">Listado de invitados secundarios</span>' . $row_sql['id'] . '</p>
                            <p id="listadoInvitados' . $row_sql['id'] . '" class="mt-3 mb-2"></p>
                            <p class="text-end">
                              <button class="btn btn-primary mt-3" type="button"><i class="bi bi-person-plus"></i> Agregar</button>
                            </p>
                          </div>
