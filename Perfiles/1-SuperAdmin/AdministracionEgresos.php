...
<body>
    ...
    <header class="navbar navbar-dark sticky-top text-light bg-warning flex-md-nowrap p-0 shadow">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <nav>
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link" href="AdministracionResidenciales.php">Zonas Residenciales</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="AdministracionIngresos.html">Ingresos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="AdministracionEgresos.html">Egresos</a>
                        </li>
                        <li class="nav-item">
                ...
                <body>
                    ...
                    <main>
                        <div
                            ...
                            <h1 class="h4">Egresos</h1>
                            <div class="btn-toolbar mb-2 mb-md-0">
                                <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal"
                                    data-bs-target="#RegistrarPagoModal">Registrar Egreso</button>
                            </div>
                            <!-- Modal -->
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="RegistrarPagoModal"><i
                                                    class="bi bi-wallet2"></i> Registrar Egreso</h5>
                                        ...
                                        <div class="modal-body">
                                            <form>
                                                <div class="row mb-3">
                                                    ...
                                                    <label for="NoFacturaR"
                                                        class="col-sm-2 col-form-label">Factura/Recibo</label>
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="NoFacturaR">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="NombreRS" class="col-sm-2 col-form-label">Nombre/Razón
                                                        Social</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="NombreRS">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-select" aria-label="Default select example">
                                                            ...
                                                            <option value="2">Pago de Personal</option>
                        ...
                        <table class="table table-responsive">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">No.Factura/Recibo</th>
                            ...
                            <tbody>
                                ...
                                <tr class="table-light">
                                    <th scope="col">E-124</th>
                                    <th scope="row">02/10/2021</th>
                                    <td><a>Juan Manuel Martínez Durán</a></td>
                                    <td>-</td>
                                    <td>350.00</td>
                                ...
                                <tr class="table-light">
                                    <th scope="col">E-123</th>
                                    <th scope="row">02/10/2021</th>
                                    <td><a>Seguridad CIO</a></td>
                                    <td>A-1547</td>
                                    <td>250.00</td>
                                    <td>Proveedor</td>
                                    <td>Transferencia</td>
                                    <td>Servicio de vigilancia correspondiente a Septiembe 2021</td>
                                    <td><a href="#" class="nav-link"><i class="bi bi-file-earmark-plus"></i></a></td>
                                </tr>
                            </tbody>
                        </table>
