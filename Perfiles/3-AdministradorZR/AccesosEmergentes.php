                                    ...
                                    <div class="" style="min-height:500px;">
                                        <div class="">     
                                            ...
                                            <form class="form-horizontal" method="post" id="codeForm" onsubmit="return false">
                                                <label for="basic-url" class="form-label">Datos para generar QR <strong><i class="bi bi-qr-code"></i></strong></label> <!-- No sale el icono -->
                                                    <div class="input-group mb-3 w-50">
                                                        <span class="input-group-text" id="basic-addon3"><i class="bi bi-diagram-2"></i></span>
                                                        <input class="form-control" list="datalistOptions" id="exampleDataList" placeholder="Corporación...">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="submit" name="submit" id="submit" class="btn btn-secondary w-50" value="Guardar Acceso">
                                                    </div>
                                                </form>
