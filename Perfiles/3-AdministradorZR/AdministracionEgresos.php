                    ...
                    <main>
                        ...
                        <h1 class="h4">Egresos</h1>
                                        <div class="btn-toolbar mb-2 mb-md-0">
                                            <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#RegistrarPagoModal">Registrar Egreso</button>
                                        </div>
                                        <!-- Modal -->
                                        <div class="modal fade" id="RegistrarPagoModal" tabindex="-1" aria-labelledby="RegistrarPagoModal" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="RegistrarPagoModal"><i class="bi bi-wallet2"></i> Registrar Egreso</h5>
                                                ...
                                                <form>
                                                    <div class="row mb-3">
                                                        ...
                                                        <label for="NoFacturaR" class="col-sm-2 col-form-label">Factura/Recibo</label>
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="NoFacturaR" >
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <label for="NombreRS" class="col-sm-2 col-form-label">Nombre/Razón Social</label>
                                                        <div class="col-sm-10">
