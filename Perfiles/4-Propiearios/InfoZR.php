        ...
        <form class="needs-validation" novalidate>
          <div class="row g-3">
            <div class="col-sm-6">
              ...
              <input type="text" class="form-control" id="firstName" placeholder="Nombre de la Zona Residencial" value="" required>
            ...
            <div class="col-sm-6">
              ...
              <input type="number" class="form-control" id="lastName" placeholder="Número total de casas y lotes" value="" required>
              <div class="invalid-feedback">
                Campo obligatorio.
              </div>
            </div>
...
<!-- Botón aparece cuando le das "onclick" al botón de EDITAR y habilita los input para editar la información -->
          <div class="d-grid gap-2">
            ...
            <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#exampleModal" style="background-color: #EB7C2A; color: white;">
