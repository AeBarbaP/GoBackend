...
<body>
    ...
    <header class="navbar navbar-dark sticky-top text-light bg-danger flex-md-nowrap p-0 shadow">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <nav>
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="AccesosAdminQR.html">Individuales</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="AccesosEmergentes.html">Emergentes</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="AccesosLimitados.html">Limitados</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="modal" data-bs-target="#LoginClaveTemporal"
                                href="../../AdministracionZR/AccesosAdminHistorial.html">Historial</a>
                        </li>
                    </ul>
                </nav>
                ...
                <body>
                    <main>
                        ...
                        <!-- Comienza Modal para Login con Clave Temporal -->
                        <div class="modal fade" id="LoginClaveTemporal" tabindex="-1"
                            aria-labelledby="Ingresa tu Clave Temporal" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header text-dark">
                                        <h5 class="modal-title" id="exampleModalLabel"><i class="bi bi-shield-lock"></i>
                                            Generar Clave Temporal</h5>
                                        ...
                                        <form class="">
                                            ...
                                            <!-- <div class="input-group mb-2">
                                                ...
                                                <input class="form-control" list="datalistOptions" id="exampleDataList"
                                                    onchange="tablaCambiar(this.value);"
                                            ...
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control rounded-4" value=""
                                                    id="ClaveTemporalInput" placeholder="Clave Temporal">
                                            ...
                                            <script>
                                                function AccesoIncorrecto() {
                                                    Swal.fire({
                                                        icon: 'error',
                                                        title: 'Oops...',
                                                        text: 'Clave Temporal Inválida!',
                                                        footer: '<a href="../../AdministracionZR/AccesosAdminHistorial.html">Ingresar sin Clave</a>' /* quitar este link, solo es para desarrollo */
                                                    });
                                                    /* alert("Copiado!"); */
                                                }
                                            </script>
                                            <a class="w-100 mb-2 btn btn-lg rounded-4 btn-secondary" type="submit"
                                                id="LoginCVETEMP" onclick="AccesoIncorrecto()"><i
                            ...
                            <div class="col-md-12">
                                <div class="h-100 p-5 text-dark bg-light border rounded-3">
                                    <div class="" style="min-height:500px;">
                                        <div class="">
                                            <div class="row">
                                                <h2>Generar acceso Individual</h2>
                                            </div>
                                            <br>
                                            <form class="form-horizontal" method="post" id="codeForm"
                                                ...
                                                <!-- No se muestra el ícono de QR -->
                                                <div class="input-group mb-3 w-100">
                                                    <span class="input-group-text" id="basic-addon3"><i
                                                            class="bi bi-person-circle"></i></span>
                                                    <input type="text" class="form-control" id="basic-url"
                                                        aria-describedby="basic-addon3" placeholder="Nombre">
                                                </div>
                                                <div class="input-group mb-3 w-100">
                                                    <span class="input-group-text" id="basic-addon3"><i
                                                            class="bi bi-phone"></i></span>
                                                    <input type="text" class="form-control" id="basic-url"
                                                        aria-describedby="basic-addon3" placeholder="Celular">
                                                </div>
                                                <div class="input-group mb-3 w-100">
                                                    <span class="input-group-text" id="basic-addon3"><i
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="1" max="10" step="1"
                                                        class="form-control col-xs-10" id="size" value="5">
                                                </div>
                                                <br>
                                                <div class="form-group">
                                                    <label class="control-label"></label>
                                                    <input type="submit" name="submit" id="submit"
                                                        class="btn btn-secondary" value="Generar código QR">
                                                </div>
                                            </form>
                                        </div>
                                        <div class="col-md-6">
