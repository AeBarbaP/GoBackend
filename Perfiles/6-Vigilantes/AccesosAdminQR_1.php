        ...
        <div class="row">
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../AdministracionZR/PropietariosAdmin.php">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Generador de QR</h1>
                ...
                <nav>
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="../QR/QR/AccesosAdminQR.html">Individuales</a>
                        </li>
                        <li class="nav-item">
                                    ...
                                    <div class="" style="min-height:500px;">
                                        <div class="">     
                                            ...
                                            <div class="input-group col-md-3">
                                                ...
                                                <label for="basic-url" class="form-label">Datos para generar QR <strong><i class="bi bi-upc-scan"></i></strong></label>
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <label class="input-group-text" for="inputGroupSelect01"><i class="bi bi-calendar-check-fill"></i></label>
