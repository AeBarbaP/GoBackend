            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="../../AdministracionZR/Home_AdminZR.html">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <nav>
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link" href="../../AdministracionZR/AccesosAdmin.html">Programados y Frecuentes</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="AccesosLimitados.html">Limitados</a>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="col-md-12">
                                <div class="h-100 p-5 text-dark bg-light border rounded-3">
                                    ...
                                    <div class="" style="min-height:500px;">
                                        <div class="">     
                                            <div class="row">
                                                <h2>Generar acceso Limitado</h2>
                                            </div>
                                            <br>
                                            <label for="basic-url" class="form-label">Cargar Imágenes</label>
                                            <div class="input-group col-md-3">
                                                <div class="input-group mb-3 w-50">
                                                    <span class="input-group-text" id="basic-addon3"><i class="bi bi-person-bounding-box"></i></span>
                                            ...
                                            <div class="input-group col-md-3">
                                                <div class="input-group mb-3 w-50">
                                                    <span class="input-group-text" id="basic-addon3"><i class="bi bi-card-text"></i></i></span>
                                                    <input class="form-control" type="file" id="formFile">
                                                </div>
                                            </div>
                                            ...
                                            <form class="form-horizontal" method="post" id="codeForm" onsubmit="return false">
                                                <label for="basic-url" class="form-label">Datos para generar QR <strong><i class="bi bi-qr-code"></i></strong></label> <!-- No se muestra el ícono de QR -->
                                                <div class="input-group mb-3 w-50">
                                                    ...
                                                    <div class="input-group mb-3 w-50">
                                                        ...
                                                        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" placeholder="Celular">
                                                    </div>
                                                    <div class="input-group mb-3 w-50">
                                                        <span class="input-group-text" id="basic-addon3"><i class="bi bi-house-door"></i></span>
                                                        <input class="form-control" list="datalistOptions" id="exampleDataList" placeholder="Domicilio...">
                                                    ...
                                                    <div class="input-group mb-3 w-50">
                                                        <label class="input-group-text" for="inputGroupSelect01"><i class="bi bi-arrow-left-right"></i></label>
