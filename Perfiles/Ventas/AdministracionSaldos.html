                        ...
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                            ...
                            <div class="btn-toolbar mb-2 mb-md-0">
                                <div class="btn-group me-2">
                                    ...
                                    <div class="modal fade" id="ConfiguracionSaldos" tabindex="-1" aria-labelledby="ConfiguracionSaldos" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header text-dark">
                                                    <h5 class="modal-title" id="exampleModalLabel"><i class="bi bi-currency-dollar"></i> Editar Saldos</h5>
                                                ...
                                                <div class="modal-body text-dark">
                                                    ...
                                                    <form class="">
                                                        <div class="form-floating mb-3">
                                                            <input type="email" class="form-control rounded-4" id="floatingInput" placeholder="MontoBancos">
                                                            <label for="floatingInput">Monto en Cuenta Bancaria</label>
                                                        </div>
                                                        <div class="form-floating mb-3">
                                                            <input type="password" class="form-control rounded-4" id="floatingPassword" placeholder="MontoEfe">
